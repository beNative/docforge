...
- **Offline (local renderer):** Invokes the PlantUML jar downloaded during build (`npm run prepare:plantuml`) through the local Java Runtime Environment, letting the app render diagrams without contacting plantuml.com.
