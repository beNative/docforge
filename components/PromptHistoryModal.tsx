            ...
            <div className="flex justify-between items-center mb-4">
                <div>
                 ...
                 <div className="flex items-center gap-2">
                    <IconButton onClick={() => handleCopy(selectedContent)} tooltip={isCopied ? "Copied!" : "Copy Content"}>
                        {isCopied ? <CheckIcon className="w-5 h-5 text-success" /> : <CopyIcon className="w-5 h-5" />}
                    </IconButton>
                    <Button onClick={() => onRestore(selectedContent)} disabled={selectedIndex === 0} variant="secondary">
